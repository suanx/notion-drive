      ...
      <div className="w-1/2 bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">上传即得永久直链</h1>
            <p className="text-white/80 text-lg">免登录、不限速的下载体验，让分享回归简单</p>
          </div>
      ...
      <div className="w-1/2 flex items-center justify-center p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">登录后即可上传文件并生成永久直链</p>
          </div>
          ...
          <div className="text-center mt-6">
            ...
            <Link href="/register" className="text-blue-600 hover:text-blue-700 text-sm font-medium ml-1">
              立即注册
            </Link>
          </div>
